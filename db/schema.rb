...
ActiveRecord::Schema[7.0].define(version: 2022_06_09_054713) do
  ...
  create_table "inspection_sheets", force: :cascade do |t|
    t.integer "user_id"
    t.json "body", default: []
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_inspection_sheets", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "user_storage_accesses", force: :cascade do |t|
